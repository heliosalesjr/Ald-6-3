...
const OSite3 = () => {
  const cardsData = [
    { title: 'Parte do quadro geral', content: '4. Compartilhar é preciso!', icon: '🌐'},
    { title: 'Capítulos do livro do estudante', content: '6. Dividindo balas durante a aula. / 7. Cem por cento dos alunos gostam de feriados. / 8. Me dá um desconto aí?', icon: '📚' },
    { title: 'Atividades do projeto', content: 'IV - Atividades. / V - Avaliação', icon: '📋' },
    { title: 'Matemática e educação financeira', content: 'Frações / Cálculo de porcentagem', icon: '🧮' },
    { title: 'Recursos didáticos', content: 'Poema de cordel / Google sites', icon: '🎮' },
  ];
