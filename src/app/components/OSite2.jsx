...
const OSite2 = () => {
  const cardsData = [
    { title: 'Parte do quadro geral', content: '3. Orçamento' },
    { title: 'Capítulos do livro do estudante', content: '4. Alcançando objetivos em família. 5. Poupando o bolso e o meio ambiente.' },
    { title: 'Atividades do projeto', content: 'III - Planejamento / IV - Atividades' },
    { title: 'Matemática e educação financeira', content: 'Operações com números racionais / Orçamento.' },
